...
function Character() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/bar.png";
 ...
 this.update = function () {
  if (keyboard.getPressed() == ' ') {
   this.image.src = "Imagenes/bar.png";
...
function Kamehameha() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/dis.png";
...
function Minicell() {
 // Properties.
 this.image = new Image(); this.image.src = "Imagenes/homer.png";
